...
public class RutaEnigmaD extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ruta_enigma_d);
        Intent intent = getIntent();
        ArrayList<String> ruta = intent.getStringArrayListExtra("rutaD");
        contadorD = intent.getIntExtra("pasoContadorC", 0);
            ...
            public void onClick(View v) {
                ...
                if (radioButton != null) {
                    ...
                    if (solucion.equals(selectedText)) {
                        Intent intentEnigmaC = new Intent(RutaEnigmaD.this, Rutas.class);
                        intentEnigmaC.putExtra("unlockedD", true);
                        intentEnigmaC.putExtra("contadorD", contadorD);
                        startActivity(intentEnigmaC);

                    } else {
                        Toast.makeText(RutaEnigmaD.this, "Respuesta Incorrecta", Toast.LENGTH_SHORT).show();
                        contadorD++;
                    }
                } else {
                    Toast.makeText(RutaEnigmaD.this, "Por favor, selecciona una opción", Toast.LENGTH_SHORT).show();
                }
            }
        });
